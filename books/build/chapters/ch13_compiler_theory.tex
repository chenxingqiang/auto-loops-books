...
\begin{itemize}
\item \textbf{Tiling is IO theory.} FlashAttention-style blocks exist to cut HBM traffic; tile search must use decode bytes/token, not GEMM FLOPs alone \citep{dao2022flashattention,memoryfloor2026,taxbreak2026,yirage2026}.
\item \textbf{Fusion has legality.} Greedy fusion without carrier/residency checks silently regresses decode \citep{dao2022flashattention,yirage2026,chen2020compilerbasedhardw,patel2025llminference}.
\item \textbf{Layout enables fusion.} Paged KV and blocked weights are compiler transforms, not runtime afterthoughts \citep{kwon2023vllm,yirage2026,chen2020compilerbasedhardw,taxbreak2026}.
\item \textbf{Parallelism is bandwidth-aware.} Flash-Decoding parallel axes help only when on-chip residency holds \citep{dao2023flashdecoding,memoryfloor2026,semianalysis2024tma,patel2025llminference}.
\item \textbf{Split backends, shared IR.} GPU/CPU/NPU emit differs; triplet regression is mandatory \citep{yirage2026,amd2024xdna,amd2024aie,chen2020compilerbasedhardw,dlbook}.
\item \textbf{Theory serves goodput.} Every pass must trace to bytes/token or launches/token on batch-1 decode \citep{taxbreak2026,memoryfloor2026,patel2025llminference,nvidia2024cudagraphs,liu2024deepseekv3,kwon2023vllm,dao2022flashattention,dao2023flashdecoding,nvidia2022hopper,semianalysis2024tma}.
\item \textbf{Pass order matters.} Layout before fusion; tiling metadata before autotune; legality before graph capture \citep{yirage2026,chen2020compilerbasedhardw,memoryfloor2026,nvidia2024cudagraphs,patel2025llminference,taxbreak2026,amd2024xdna,amd2024aie,dlbook}.
\item \textbf{CI mirrors theory.} Golden IR diffs, stride snapshots, and triplet bytes/token gates turn principles into merge blockers \citep{yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,semianalysis2024tma,dlbook,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna}.
\end{itemize}
