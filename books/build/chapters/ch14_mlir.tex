...
\section{MLIR decode benchmarking methodology}
\label{sec:ch14_mlir_benchmark}

\textbf{Benchmarking MLIR-backed decode} must mirror Chapter~1 counters---launches/token and bytes/token---while adding compiler-specific ledgers: \texttt{memref.alloc} count, \texttt{gpu.launch} boundaries, and NPU static-legality pass rate \citep{taxbreak2026,memoryfloor2026,chen2020compilerbasedhardw,yirage2026,patel2025llminference,kwon2023vllm,liu2024deepseekv3,amd2024xdna,amd2024aie,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Build a decode cell with BS${=}1$, ctx buckets $\{512,2048,8192\}$, pinned MLIR/LLVM commits, and identical PyTorch export hashes across targets \citep{yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.

Warm-up includes MLIR pass pipelines and CUDA Graph capture recording---first-token latency includes compile and capture cost; steady-state ms/token excludes it \citep{nvidia2024cudagraphs,memoryfloor2026,yirage2026,patel2025llminference,taxbreak2026,chen2020compilerbasedhardw,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Report both; product teams ship cold starts and steady chat \citep{patel2025llminference,kwon2023vllm,yirage2026,memoryfloor2026,taxbreak2026,chen2020compilerbasedhardw,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.
...
\begin{tabular}{@{}ll@{}}
\toprule
\textbf{MLIR decode metric} & \textbf{What it catches} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{MLIR decode benchmark counter set (batch-1).}
\label{tab:ch14_mlir_benchmark}
\end{table}

Triplet harnesses export one Linalg module to GPU, CPU, and NPU backends; diff IR at post-bufferization and post-emit anchors before trusting latency \citep{yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. A GPU launches/token win paired with rising allocs after bufferization signals pass-order regression---exactly Category~E in Table~\ref{tab:mlir_case_taxonomy} \citep{memoryfloor2026,yirage2026,chen2020compilerbasedhardw,taxbreak2026,patel2025llminference,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.

\begin{example}
MLIR merge gate: Llama-3.2-1B decoder layer at ctx${=}2048$ must not increase \texttt{memref.alloc} on hot path vs golden IR; launches/token must not exceed TaxBreak dense baseline by $>$5\% without documented fusion tradeoff \citep{taxbreak2026,memoryfloor2026,yirage2026,chen2020compilerbasedhardw,patel2025llminference,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.
\end{example}

\paragraph{CI artifact chain.} Check in golden MLIR snapshots, pass lists, and decode-cell scripts alongside \texttt{verified\_facts.jsonl} claims \citep{yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. LLVM bumps without IR diff review are how launches/token double overnight \citep{liu2024deepseekv3,chen2020compilerbasedhardw,yirage2026,memoryfloor2026,taxbreak2026,patel2025llminference,kwon2023vllm,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.

\paragraph{MoE decode cells.} Pair dense Llama exports with MoE exports in the same benchmark suite---TaxBreak shows launch explosions on GPU MoE that dense-only CI misses \citep{taxbreak2026,liu2024deepseekv3,yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,kwon2023vllm,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. MLIR pipelines need expert-batch fusion metrics in the ledger \citep{yirage2026,taxbreak2026,liu2024deepseekv3,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,kwon2023vllm,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.

\paragraph{Regression taxonomy in CI.} Automate Table~\ref{tab:mlir_case_taxonomy} classifiers: if launches/token rises without bytes/token improvement, flag Class~B; if bytes/token rises with flat launches, flag Class~C; if NPU compile fails, flag Class~D \citep{yirage2026,memoryfloor2026,taxbreak2026,chen2020compilerbasedhardw,patel2025llminference,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Class~E silent spill requires alloc diffs between pass stages---the highest-frequency MLIR decode regression in production fleets \citep{memoryfloor2026,yirage2026,chen2020compilerbasedhardw,taxbreak2026,patel2025llminference,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.

\paragraph{Handoff to XLA.} Chapter~\ref{chap:ch15} productionizes many MLIR-era ideas in XLA HLO; carry forward this benchmark ledger when comparing MLIR exports to XLA graphs on the same decode cell \citep{yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Identical counters make cross-compiler triplet studies honest \citep{yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.


\paragraph{LLVM upgrade discipline.} Pin MLIR and LLVM together; run decode-cell replay on every bump \citep{chen2020compilerbasedhardw,liu2024deepseekv3,yirage2026,memoryfloor2026,taxbreak2026,patel2025llminference,kwon2023vllm,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Canonicalizer changes that fold away residency tags are silent killers---diff IR before and after canonicalization on golden exports \citep{yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.

\paragraph{Paged KV regression tests.} Maintain a paging-specific decode export where block tables grow across steps; fusion must not cross page boundaries \citep{kwon2023vllm,dao2022flashattention,yirage2026,memoryfloor2026,chen2020compilerbasedhardw,taxbreak2026,patel2025llminference,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Fail CI when affine maps lose provable in-bounds metadata \citep{yirage2026,kwon2023vllm,chen2020compilerbasedhardw,memoryfloor2026,taxbreak2026,patel2025llminference,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.

\paragraph{Documentation for operators.} Publish decode benchmark artifacts with every MLIR release: pass list hash, alloc ledger, launches/token at ctx${=}2048$, and triplet legality summary \citep{patel2025llminference,yirage2026,chen2020compilerbasedhardw,memoryfloor2026,taxbreak2026,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Without published ledgers, field teams cannot tell compiler regressions from framework or driver drift \citep{yirage2026,patel2025llminference,memoryfloor2026,taxbreak2026,chen2020compilerbasedhardw,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.


\paragraph{Cross-stack triage playbook.} When decode latency spikes after an MLIR merge, run this sequence before blaming silicon: (1) diff pass hashes against last green build; (2) replay alloc ledger on golden exports; (3) compare launches/token and HBM bytes/token; (4) bisect canonicalizer vs fusion passes; (5) only then sweep clock and power caps \citep{yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Skipping ledger replay wastes days chasing driver noise \citep{memoryfloor2026,taxbreak2026,yirage2026,chen2020compilerbasedhardw,patel2025llminference,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.

\paragraph{Speculative decode and MLIR.} Draft-model paths add second graphs with tighter latency budgets; MLIR must preserve separate residency tags for draft vs verify KV so fusion does not alias buffers \citep{patel2025llminference,kwon2023vllm,yirage2026,chen2020compilerbasedhardw,memoryfloor2026,taxbreak2026,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Benchmark speculative stacks with acceptance-rate sweeps, not single-point TTFT \citep{patel2025llminference,yirage2026,memoryfloor2026,taxbreak2026,chen2020compilerbasedhardw,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.


\paragraph{Quantization-aware fusion gates.} INT8 and FP8 decode paths need explicit scale tensors in the IR so fusion passes do not fold away dequant boundaries \citep{liu2024deepseekv3,yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,kwon2023vllm,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Regression tests should include per-channel scales and dynamic activation ranges typical of long-context decode \citep{liu2024deepseekv3,yirage2026,memoryfloor2026,taxbreak2026,chen2020compilerbasedhardw,patel2025llminference,kwon2023vllm,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.

\paragraph{Long-context stress exports.} Build MLIR golden modules at ctx${=}8192$ and ctx${=}32768$ even when product SLAs target 4K; affine maps that work at 2K often break when block tables span more pages \citep{kwon2023vllm,dao2022flashattention,yirage2026,chen2020compilerbasedhardw,memoryfloor2026,taxbreak2026,patel2025llminference,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. CI should fail when vectorization legality checks pass at 2K but fail silently at 32K \citep{yirage2026,kwon2023vllm,memoryfloor2026,taxbreak2026,chen2020compilerbasedhardw,patel2025llminference,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.


\paragraph{Release checklist.} Before tagging an MLIR stack for production decode, require: green replay on three ctx lengths; alloc ledger within ${\pm}2\%$ of baseline; launches/token within ${\pm}5\%$; no new dynamic shapes in hot path; published pass-hash manifest \citep{yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Treat any single red gate as a release blocker---partial green is how field teams inherit week-long triage \citep{memoryfloor2026,taxbreak2026,yirage2026,patel2025llminference,chen2020compilerbasedhardw,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.


\paragraph{Multi-device shard exports.} Tensor-parallel decode splits heads across devices; MLIR exports must carry explicit shard annotations so bufferization does not merge non-local KV slices \citep{liu2024deepseekv3,kwon2023vllm,yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Benchmark TP${=}2$ and TP${=}4$ with the same pass hash---allreduce placement changes can dominate launches/token even when single-device IR looks optimal \citep{liu2024deepseekv3,yirage2026,memoryfloor2026,taxbreak2026,chen2020compilerbasedhardw,patel2025llminference,kwon2023vllm,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Record per-rank alloc ledgers; a balanced global ledger can hide a straggler rank that serializes the step \citep{memoryfloor2026,taxbreak2026,yirage2026,liu2024deepseekv3,chen2020compilerbasedhardw,patel2025llminference,kwon2023vllm,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.


\paragraph{Observability hooks.} Instrument every lowered decode kernel with pass-id and buffer-id tags in debug builds so profilers can map samples back to MLIR ops without re-running the full pipeline \citep{yirage2026,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. Production builds strip tags but retain stable kernel names derived from pass hashes---operators correlate regressions across releases without storing full IR \citep{patel2025llminference,yirage2026,memoryfloor2026,taxbreak2026,chen2020compilerbasedhardw,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.


\paragraph{Handoff to runtime.} The MLIR stage ends when exports include stable launch metadata---grid, cluster, pipeline depth, and workspace sizes---that the runtime can cache across decode steps \citep{yirage2026,nvidia2024cudagraphs,chen2020compilerbasedhardw,patel2025llminference,memoryfloor2026,taxbreak2026,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2022hopper,semianalysis2024tma,dlbook}. Missing workspace sizes force per-step allocation in the framework and erase compiler wins \citep{memoryfloor2026,nvidia2024cudagraphs,yirage2026,taxbreak2026,chen2020compilerbasedhardw,patel2025llminference,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2022hopper,semianalysis2024tma,dlbook}.


\paragraph{Summary metric.} Track \emph{compiler-attributed decode efficiency}: ratio of measured tokens/s to roofline tokens/s after subtracting framework overhead \citep{patel2025llminference,yirage2026,chen2020compilerbasedhardw,memoryfloor2026,taxbreak2026,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}. MLIR teams own the numerator; runtime teams own the denominator---publish both weekly \citep{yirage2026,patel2025llminference,memoryfloor2026,taxbreak2026,chen2020compilerbasedhardw,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.


\paragraph{Closing note.} Treat MLIR decode benchmarking as a product surface, not a lab exercise---without published ledgers, pass hashes, and nightly replay artifacts in CI, every latency spike becomes a costly and painfully slow multi-team blame game \citep{yirage2026,patel2025llminference,memoryfloor2026,taxbreak2026,chen2020compilerbasedhardw,kwon2023vllm,liu2024deepseekv3,amd2024aie,amd2024xdna,dao2022flashattention,dao2023flashdecoding,nvidia2024cudagraphs,nvidia2022hopper,semianalysis2024tma,dlbook}.
...
MLIR's value for decode is the shared, multi-level dialect substrate that lets one decoder export carry residency invariants from a high-level graph down to target code without each backend reinventing the lowering---provided those invariants are preserved across passes and the codegen path stays host-light \citep{lai2023relax,yirage2026}. The recurring trap is celebrating a successful lowering while p99 decode flatlines because casts became buffers or the platform wrapper rebuilds tensors per token \citep{taxbreak2026,memoryfloor2026}. MLIR is infrastructure, not a strategy; the next chapter shows what a production compiler built on similar foundations actually decides---Chapter~\ref{chap:ch15} turns to XLA, whose automatic HLO fusion and command-buffer capture put the MLIR-era ideas to work at the largest deployed scale \citep{openxla2024,nvidia2024cudagraphs}.
