...
\begin{itemize}
\item \textbf{Mlir Hw Matrix.} Tie mlir hw matrix to bytes/token and multi-hardware legality \citep{yirage2026,taxbreak2026,memoryfloor2026}.
\item \textbf{Mlir Arch Passes.} Tie mlir arch passes to bytes/token and multi-hardware legality \citep{yirage2026,taxbreak2026,memoryfloor2026}.
\item \textbf{Mlir Codegen.} Tie mlir codegen to bytes/token and multi-hardware legality \citep{yirage2026,taxbreak2026,memoryfloor2026}.
\item \textbf{Mlir Tuning.} Tie mlir tuning to bytes/token and multi-hardware legality \citep{yirage2026,taxbreak2026,memoryfloor2026}.
\item \textbf{Mlir Case Study.} Tie mlir case study to bytes/token and multi-hardware legality \citep{yirage2026,taxbreak2026,memoryfloor2026}.
