...
\begin{itemize}
\item \textbf{HW-aware profiling.} Freeze decode cells; normalize GPU/CPU/NPU tools to bytes/token and launches/token \citep{patel2025llminference,memoryfloor2026,taxbreak2026,semianalysis2024tma,amd2024xdna}.
\item \textbf{Bottleneck locating.} Classify launch-, memory-, residency-, or framework-bound before changing compiler knobs \citep{nvidia2024cudagraphs,dao2022flashattention,yirage2026,kwon2023vllm}.
\item \textbf{Tuning workflow.} One knob per experiment; human prior baseline; canary on fleet \citep{chen2020compilerbasedhardw,yirage2026,memoryfloor2026,patel2025llminference}.
\item \textbf{Regression gates.} CI enforces counter non-regression, legality, and versioned artifacts \citep{yirage2026,chen2020compilerbasedhardw,liu2024deepseekv3,amd2024aie}.
\item \textbf{Measure useful decode work.} Profile-first beats tile-size folklore \citep{patel2025llminference,dlbook,semianalysis2024tma}.
\end{itemize}
