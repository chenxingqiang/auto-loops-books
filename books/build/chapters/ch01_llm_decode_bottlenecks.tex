...
\begin{tikzpicture}[vis base, x=0.42cm, y=0.07cm]
 ...
 \fill[visFillSecondary] (1,0) rectangle (4.2,84.8) node[midway, rotate=90, font=\scriptsize] {Llama-1B};
 \fill[visFillPrimary] (6,0) rectangle (9.2,93.1) node[midway, rotate=90, font=\scriptsize] {OLMoE};
 \fill[visFillSecondary!70] (11,0) rectangle (14.2,67.0) node[midway, rotate=90, font=\scriptsize] {Qwen-MoE};
...
\begin{tikzpicture}[vis base, x=1.1cm, y=0.5cm]
 ...
 \foreach \y/\w in {0/1.0, 1/1.4, 2/1.8, 3/2.4, 4/3.2}
   \draw[fill=visFillSecondary] (0.1,\y) rectangle (\w,\y+0.7);
