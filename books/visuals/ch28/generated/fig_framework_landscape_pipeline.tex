...
\begin{tikzpicture}[vis base, scale=0.88, transform shape]
    \node[vis pipeline node] (s0) at (-5.03,0) {\footnotesize Input\\framework landscape};
...
\end{tikzpicture}
\end{adjustbox}
\caption{framework landscape optimization pipeline in LLM Inference Frameworks and Serving Runtimes.}
