...
- **内容 R-next**：ch23/ch26/ch27 deep-rewrite（scope 检测 strip 后 ~690w）；Part VI ch15–17 residual pad strip。
- **Harness R-next**：batch `--apply --range 15-27 --force --adjust-min` 用新 detector 清 residual pad。
